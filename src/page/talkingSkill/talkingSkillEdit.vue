                    ...
                    <el-row style="padding: 0 10%">
                        <el-form :model="postData" label-width="150px" size="">
                            ...
                            <el-form-item label="话术版本：">
                                <el-input :disabled="type === 'view'" v-model="postData.version"></el-input>
                            </el-form-item>
                            <el-form-item label="话术类型：">
                                <el-select :disabled="type === 'view'" v-model="postData.learningType" placeholder="请选择知识类型">
                                    <el-option :disabled="type === 'view'" label="客服技巧" value="客服技巧"></el-option>
                                    <el-option :disabled="type === 'view'" label="必备话术" value="必备话术"></el-option>
                                </el-select>
                            </el-form-item>
