    ...
    <div class="fillcontain">
        ...
        <el-card class="box-card">
            ...
            >
                ...
                <el-table-column
                    prop="company.manager_person_name"
                    label="负责人"
                    :show-overflow-tooltip="true"
                    align="center"
                    minWidth="260"
                ...
                <el-table-column
                    prop="company.manager_person_phone"
                    label="负责人电话"
                    align="center"
                    minWidth="230"
                >
...
export default {
    ...
    data() {
        return {
            queryCondition: { // 查询条件
                taskTypeName: ['HouseEntering'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditInEnterDetails/${row.taskId}` })
        },
        resetForm() {
