            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        ...
                        >
                            <viewer :images="scope.row.img_url.split(',')">
                                <img
                                    v-for="url in scope.row.img_url.split(',')"
                                    :key="$md5(url)"
                                    :src="url"
                                />
                            </viewer>
...
export default {
    ...
    data() {
        return {
            queryCondition: { // 查询条件
                taskTypeName: ['HouseEvaluate'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditRealtyEvaluateDetails/${row.taskId}` })
        },
        resetForm() {
