            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <el-link
                            type="primary"
                            @click="auditHouseNewsDetails(scope.row)"
...
export default {
    data() {
        return {
            queryCondition: { // 查询条件
                taskTypeName: ['HouseMessageTempleAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditHouseNewsDetails(row) {
            this.$router.push({ path: `auditHouseNewsDetails/${row.taskId}` })
        },
        resetForm() {
