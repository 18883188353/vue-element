    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            >
                ...
                <el-table-column
                    prop="Certificateinfo.company_name"
                    label="公司名称"
                    align="center"
                    minWidth="260"
                    :show-overflow-tooltip="true"
                ...
                <el-table-column
                    prop="Certificateinfo.manager_person_name"
                    label="负责人姓名"
                    align="center"
                    width="160"
                >
                ...
                <el-table-column
                    prop="Certificateinfo.manager_person_phone"
                    label="负责人电话"
                    align="center"
                    width="160"
                >
...
export default {
    ...
    data() {
        return {
            ...
            queryCondition: { // 查询条件
                taskTypeName: ['HouseEditCompany'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `realtyCompanyAuditChangeDetails/${row.taskId}` });
        }
