            ...
            <div class="text item mb30">
                <el-row style="padding: 0 5%">
                    <el-form
                        ...
                        size="mini"
                    >
                        <el-form-item label="订单编号：">{{ detailEntity.orderNo }}</el-form-item>
                        <el-form-item label="商品名称：">{{ detailEntity.title }}</el-form-item>
                        <el-form-item label="评价内容：" style="word-wrap:break-word;">{{ detailEntity.comment_content }}</el-form-item>
                        <el-form-item label="评价图片：">
                            <div
                                class="img-hw100"
                                v-if="detailEntity.comment_pics"
                            >
                                <viewer :images="detailEntity.comment_pics.split(',')">
                                    <img
                                        v-for="url in detailEntity.comment_pics.split(',')"
                                        :key="$md5(url)"
                                        :src="url"
                        ...
                        <el-form-item label="评价用户：">{{ detailEntity.comment_userName }}</el-form-item>
            ...
            <div class="text item mb30">
                <el-row style="padding: 0 5%">
                    <el-form
                        ...
                        size="mini"
                    >
                        <el-form-item label="回复内容：">{{ detailEntity.content }}</el-form-item>
                    </el-form>
                </el-row>
            </div>
        </el-card>-->
                ...
                <el-row style="padding: 0 5%">
                    ...
                    <el-col :span="24">
                        <el-form
                            ...
                            size="mini"
                        >
                            <el-form-item label="回复用户：">{{ detailEntity.reply_userName }}</el-form-item>
                            <el-form-item label="回复内容：" style="word-wrap:break-word;">{{ detailEntity.reply_content }}</el-form-item>
                        </el-form>
                    </el-col>
