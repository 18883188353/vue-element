            ...
            <div class="text item mb30">
                <el-row style="padding: 0 5%">
                    ...
                    >
                        ...
                        <el-form-item label="广告二级标题：">{{ detailEntity.sub_title }}</el-form-item>
                        ...
                        <el-form-item label="广告跳转方式：">
                            ...
                            <span v-else-if="detailEntity.material_type === 5">无</span>
                            <span v-else-if="detailEntity.material_type === 6">分类</span>
                            <span v-else-if="detailEntity.material_type === 7">app内部跳转</span>
                        </el-form-item>
                        <el-form-item
                            label="商品信息："
                        ...
                        <el-form-item
                            label="分类ID："
                            v-if="detailEntity.material_type === 6"
                        >
                            {{ detailEntity.product_id }}
                        </el-form-item>
                        <el-form-item
                            label="app内部链接地址："
                            v-if="detailEntity.material_type === 7"
                        >
                            <div v-if="detailEntity.target_url">
                                <el-link
                                    :href="detailEntity.target_url"
                        ...
                        <el-form-item label="描述：">{{ detailEntity.remark }}</el-form-item>
...
export default {
    ...
    methods: {
        ...
        submitAudit() {
            ...
            auditResult.audit_user_id = this.userInfo.id;
            auditResult.audit_user_name = this.userInfo.rel_name;
