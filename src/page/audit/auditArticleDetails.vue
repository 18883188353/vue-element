                ...
                <el-row style="padding: 0 5%">
                    ...
                    <el-col :span="24">
                        <el-form
                            ...
                            size="mini"
                        >
                            <el-form-item label="文章标题：">{{ detailEntity.Title }}</el-form-item>
                            <el-form-item label="文章类型：">{{ detailEntity.CategoryTitle }}</el-form-item>
                            <el-form-item label="商品推广数：">{{ detailEntity.ArticleId ? detailEntity.ArticleId.split(',').length : 0 }}</el-form-item>
                            <el-form-item label="文章内容：">
                                <div class="html-content">
                                    <vue-scroll>
                                        <div v-html="detailEntity.Content"></div>
                                    </vue-scroll>
                                </div>
                            </el-form-item>
                        </el-form>
