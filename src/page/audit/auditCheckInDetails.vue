            ...
            <div class="text item">
                ...
                >
                        ...
                        <el-row v-if="detailEntity.company">
                            ...
                            <el-col :span="12">
                                ...
                                >
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.relType.verifyList"
                                            label="Verify_101"
                                        >经办人电话核实</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.relType.verifyList"
                                            label="Verify_103"
                                        >公司座机电话核实</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.relType.verifyList"
                                            label="Verify_104"
                                        >商家是否愿意入驻</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-input
                                            v-model="verify.relType.remark"
                                            type="textarea"
                                            :rows="4"
                                            placeholder="请输入审核记录"
                                        ></el-input>
                        ...
                        <el-row v-if="detailEntity.company">
                            ...
                            <el-col :span="12">
                                ...
                                >
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.company.verifyList"
                                            label="Verify_201"
                                        >国家企业信息公示系统核验</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.company.verifyList"
                                            label="Verify_202"
                                        >营业执照清晰且端正</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.company.verifyList"
                                            label="Verify_203"
                                        >营业执照有效期核实</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.company.verifyList"
                                            label="Verify_204"
                                        >营业执照类别核实</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.company.verifyList"
                                            label="Verify_205"
                                        >信用代码应与执照一致</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-input
                                            v-model="verify.company.remark"
                                            type="textarea"
                                            :rows="4"
                                            placeholder="请输入审核记录"
                                        ></el-input>
                        ...
                        <el-row v-if="detailEntity.company">
                            ...
                            <el-col :span="12">
                                ...
                                >
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.legal.verifyList"
                                            label="Verify_301"
                                        >法人姓名核实</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                        ...
                        <el-row v-if="detailEntity.shopInfo">
                            ...
                            <el-col :span="12">
                                ...
                                >
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.shop.verifyList"
                                            label="Verify_401"
                                        >食品安全许可证</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                    ...
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.shop.verifyList"
                                            label="Verify_408"
                                        >化妆品生产许可证</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-checkbox
                                            v-model="verify.shop.verifyList"
                                            label="Verify_409"
                                        >农药产品生产许可证</el-checkbox>
                                    </el-form-item>
                                    <el-form-item label="">
                                        <el-input
                                            v-model="verify.shop.remark"
                                            type="textarea"
                                            :rows="4"
                                            placeholder="请输入审核记录"
                                        ></el-input>
                    ...
                    <el-tab-pane
                        label="附件"
                        name="accessFile"
                        v-if="detailEntity.salesmanInfo"
                    >
                        <el-row>
                            <el-col :span="24">
                                ...
                                <el-form
                                    ...
                                    class="mt20"
                                >
                                    <el-form-item label="门头照或经典照片：">
                                        <div
                                            class="img-hw100"
                                            v-if="detailEntity.salesmanInfo.door_photo"
                                        >
                                            <viewer :images="detailEntity.salesmanInfo.door_photo.split(',') || []">
                                                <img
                                                    v-for="url in detailEntity.salesmanInfo.door_photo.split(',')"
                                                    :key="url"
                                                    :src="url"
                                                    style="margin-right:3px"
                                                />
                                    ...
                                    <el-form-item label="房间及环境图片：">
                                        <div
                                            class="img-hw100"
                                            v-if="detailEntity.salesmanInfo.store_photo"
                                        >
                                            <viewer :images="detailEntity.salesmanInfo.store_photo.split(',') || []">
                                                <img
                                                    v-for="url in detailEntity.salesmanInfo.store_photo.split(',')"
                                                    :key="url"
                                                    :src="url"
                                                    style="margin-right:3px"
                                                />
                        ...
                        <el-row v-if="isAudit">
                            ...
                            >
                                <el-form-item label="">
                                    <el-radio
                                        v-model="auditTypeResult.accessFile.audit_status"
                                        :label="1"
                                    >通过</el-radio>
                                    <el-radio
                                        v-model="auditTypeResult.accessFile.audit_status"
                                ...
                                <el-form-item
                                    v-if="auditTypeResult.accessFile.audit_status === 0"
                                    class="audit-result"
                                >
                                    <el-col
                                        :span="12"
                                    ...
                                    >
                                        <vue-scroll>
                                            <el-input
                                                ...
                                                :autosize="true"
                                                placeholder="请输入不通过理由"
                                                v-model="auditTypeResult.accessFile.audit_remark"
                                            ></el-input>
                                        </vue-scroll>
                                    </el-col>
                                    <el-col :span="12">
                                        <ul>
                                            <vue-scroll>
                                                <li
                                                    v-for="(result, idx) in resultSelect.accessFile"
                                                    :key="idx"
                                                    @click="auditTypeResult.accessFile.audit_remark += result"
                                                >
                                                    {{ result }}
                                                </li>
                                            </vue-scroll>
                    ...
                    <el-tab-pane
                        ...
                        name="bankCard"
                    >
                        <el-row v-if="detailEntity.bankInfo">
                            <el-col :span="24">
                                <el-form
                                    label-width="180px"
                                    size="mini"
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            ...
                                            v-if="detailEntity.bankInfo.license_url"
                                        >
                                            <viewer :images="[detailEntity.bankInfo.license_url]">
                                                <img :src="detailEntity.bankInfo.license_url" />
                                            </viewer>
                                        </div>
                                    </el-form-item>
                                </el-form>
...
export default {
    ...
    methods: {
        init() {
            AuditDetail.call(this, { taskId: this.id }).then(res => {
                if (res.Code === 1) {
                    ...
                    this.auditTypeResult.accessFile.id = this.detailEntity.shopInfo.id
        ...
        initCategory(taskTypeName) {
            let isGolb;
            switch (taskTypeName) {
                case 'DomesticEntering': isGolb = 0; break;
                case 'GlobalEntering': isGolb = 1; break;
                case 'LuxuryEntering': isGolb = 2; break;
                default: break;
            }
            ...
            GetCategory.call(this, {
                categoryType: 'Goods',
                isGolb: isGolb //'DomesticEntering' === taskTypeName ? 0 : 1
            }).then(res => {
        ...
        submitAudit() {
            ...
            for (let key in this.auditTypeResult) {
                ...
                // 如果没有附件、则附件一项跳过验证是否审核
                if (key === 'accessFile' && !this.detailEntity.salesmanInfo) {
                    //oneType.audit_status = 0;
                    continue;
                }
