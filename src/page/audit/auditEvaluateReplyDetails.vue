            ...
            <div class="text item mb30">
                <el-row style="padding: 0 5%">
                    ...
                    >
                        ...
                        <el-form-item label="商品评分：">{{ detailEntity.score }}分</el-form-item>
                        <el-form-item label="评价内容：" style="word-wrap:break-word;">{{ detailEntity.content }}</el-form-item>
                        ...
                        <el-form-item label="评价时间：">{{ detailEntity.commentTime }}</el-form-item>
                    </el-form>
                </el-row>
            </div>
        </el-card>
                ...
                <el-row style="padding: 0 5%">
                    ...
                    <el-col :span="24">
                        ...
                        >
                            ...
                            <el-form-item label="回复时间：">{{ detailEntity.reply_time }}</el-form-item>
                        </el-form>
                    </el-col>
