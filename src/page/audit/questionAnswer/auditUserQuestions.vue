...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'UserQuestionsAudit'
            }, {
                name: '全球购',
                code: 'GlobalUserQuestionsAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryUserQuestionsAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['UserQuestionsAudit', 'GlobalUserQuestionsAudit', 'LuxuryUserQuestionsAudit'], // 审核任务名称
    ...
    methods: {
        ...
        goAuditDetail(row) {
            this.$router.push({ path: `auditUserQuestionsDetail/${row.taskId}` })
        },
        resetForm() {
