            ...
            <div class="text item">
                <el-row style="padding: 0 5%">
                    ...
                    >
                        ...
                        <el-form-item label="提问内容：">{{ detailEntity.questionContent }} </el-form-item>
                    </el-form>
                </el-row>
            </div>
        </el-card>
            ...
            <div class="text item">
                <el-row style="padding: 0 5%">
                    <el-col :span="24">
                        ...
                        >
                            <el-form-item label="商品信息：">{{ detailEntity.articleTitle }}</el-form-item>
                            <el-form-item label="回复内容：">{{ detailEntity.answerContent }}</el-form-item>
                            <!--<el-form-item label="回复用户：">{{ detailEntity.userName }}</el-form-item>
                    ...
                    >
                        <el-form-item label="信誉分：">
                            <el-radio-group v-model="scoreOption">
