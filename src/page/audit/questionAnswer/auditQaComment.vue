...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'QuestionsCommentAudit'
            }, {
                name: '全球购',
                code: 'GlobalQuestionsCommentAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryQuestionsCommentAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['QuestionsCommentAudit', 'GlobalQuestionsCommentAudit' ,'LuxuryQuestionsCommentAudit'], // 审核任务名称
    ...
    methods: {
        ...
        goAuditDetail(row) {
            this.$router.push({ path: `auditQaCommentDetail/${row.taskId}` })
        },
        resetForm() {
