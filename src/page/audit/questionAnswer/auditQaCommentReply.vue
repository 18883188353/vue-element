...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'ReplyCommentAudit'
            }, {
                name: '全球购',
                code: 'GlobalReplyCommentAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryReplyCommentAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['ReplyCommentAudit', 'GlobalReplyCommentAudit', 'LuxuryReplyCommentAudit'], // 审核任务名称
    ...
    methods: {
        ...
        goAuditDetail(row) {
            this.$router.push({ path: `auditQaCommentReplyDetail/${row.taskId}` })
        },
        resetForm() {
