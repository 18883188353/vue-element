...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'ShopAnswerAudit'
            }, {
                name: '全球购',
                code: 'GlobalShopAnswerAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryShopAnswerAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['ShopAnswerAudit', 'GlobalShopAnswerAudit', 'LuxuryShopAnswerAudit'], // 审核任务名称
    ...
    methods: {
        ...
        goAuditDetail(row) {
            this.$router.push({ path: `auditShopAnswerDetail/${row.taskId}` })
        },
        resetForm() {
