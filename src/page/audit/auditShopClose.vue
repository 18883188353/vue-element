    ...
    <div class="fillcontain">
        ...
        <el-card>
            ...
            >
                ...
                <el-table-column
                    prop="ShopInfo.ShopType"
                    label="商家类型"
                    align="center"
                    width="150"
                >
                    <template slot-scope="scope">
                        <span v-if="scope.row.ShopInfo.ShopType === 0">普通店</span>
                        <span v-if="scope.row.ShopInfo.ShopType === 1">旗舰店</span>
                        <span v-if="scope.row.ShopInfo.ShopType === 2">全球购</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="CompanyInfo.ManagerPhone"
                    label="负责人电话"
                    align="center"
                    width="130"
                >
                ...
                <el-table-column
                    prop="CompanyInfo.LegalPersonMobile"
                    label="法人电话"
                    align="center"
                    width="130"
                >
    ...
    data() {
        return {
            taskTypeNames: [{
                ...
                name: '全球购',
                code: 'GlobalCloseEntering'
            }, {
                name: '奢侈品',
                code: 'LuxuryCloseEntering'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['CloseEntering', 'GlobalCloseEntering', 'LuxuryCloseEntering'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditShopCloseDetails/${row.taskId}` })
        },
        resetForm() {
