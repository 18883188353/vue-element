    ...
    <div>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!--<el-option
                                    label="国内购"
                                    value="DomesticEntering"
                                    :disabled="queryCondition.taskTypeName[0] === 'DomesticEntering' && queryCondition.taskTypeName.length === 1"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalEntering"
                                    :disabled="queryCondition.taskTypeName[0] === 'GlobalEntering' && queryCondition.taskTypeName.length === 1"
                                ></el-option>
                                <el-option
                                    label="农村满集"
                                    value="RuralEntering"
                                    :disabled="queryCondition.taskTypeName[0] === 'RuralEntering' &&queryCondition.taskTypeName.length === 1"
                                ></el-option>-->
                            </el-select>
                        </el-form-item>
                        <el-form-item
        ...
        <el-card class="box-card">
            ...
            >
                ...
                <el-table-column
                    prop="shopInfo.salesman_user_phone"
                    label="业务员电话"
                    align="center"
                    width="130"
                >
...
export default {
    ...
    data() {
        return {
            ...
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticEntering', 'GlobalEntering', 'LuxuryEntering', 'RuralEntering'], // 审核任务名称
    ...
    methods: {
        ...
        selectTaskTypeNames(e, e2) {
            console.log(e);
            console.log(e2);
            if (e.length === 0) {
                this.queryCondition.taskTypeName = ['DomesticEntering']
            }
        },
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditCheckInDetails/${row.taskId}` })
        }
