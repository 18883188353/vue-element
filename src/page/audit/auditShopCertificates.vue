                    ...
                    >
                        ...
                        >
                            ...
                            ><el-option
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticCredentailsAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalCredentailsAudit"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticCredentailsAudit'
            }, {
                name: '全球购',
                code: 'GlobalCredentailsAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryCredentailsAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticCredentailsAudit','GlobalCredentailsAudit', 'LuxuryCredentailsAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditShopCertificatesDetails/${row.taskId}` });
        }
