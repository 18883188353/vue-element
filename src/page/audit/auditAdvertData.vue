            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <span v-if="scope.row.material_type === 0">商品</span>
                        <span v-else-if="scope.row.material_type === 1">店铺</span>
                        <span v-else-if="scope.row.material_type === 2">内部链接</span>
                        <span v-else-if="scope.row.material_type === 3">外部链接</span>
                        <span v-else-if="scope.row.material_type === 4">品牌</span>
                    </template>
                </el-table-column>
                <el-table-column
                    prop="width"
