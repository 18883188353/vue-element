...
export default {
    ...
    data() {
        return {
            ...
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticDataChangeAudit'], // 审核任务名称
    ...
    methods: {
            ...
            QueryTaskList.call(this, { ...this.queryCondition, ...this.paging }).then(res => {
                ...
                if (res.Code === 1) {
                    ...
                    this.tableList = res.Data.Data && res.Data.Data.map(n => {
                        ...
                        n.entityData = entityInfo;
                        if (entityInfo.BusinessBefore) {
                            n.company_name = entityInfo.BusinessBefore.name;
                            n.LegalPersonName = entityInfo.BusinessBefore.legalPerson;
                            n.LegalPersonMobile = entityInfo.BusinessBefore.legalPersonMobile;
                            n.ManagerName = entityInfo.BusinessBefore.manager;
                            n.MangeMobile = entityInfo.BusinessBefore.managerPhone;
                        }
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditBankChangeDetails/${row.taskId}` })
        }
