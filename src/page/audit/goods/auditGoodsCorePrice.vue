                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticPriceAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalPriceAudit"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticPriceAudit'
            }, {
                name: '全球购',
                code: 'GlobalPriceAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryPriceAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticPriceAudit', 'GlobalPriceAudit', 'LuxuryPriceAudit'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditGoodsCorePriceDetails/${row.taskId}` })
        }
    },
    created() {
