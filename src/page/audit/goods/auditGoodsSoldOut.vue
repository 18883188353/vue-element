                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticObtainedAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalObtainedAudit"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticObtainedAudit'
            }, {
                name: '全球购',
                code: 'GlobalObtainedAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryObtainedAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticObtainedAudit', 'GlobalObtainedAudit', 'LuxuryObtainedAudit'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditGoodsSoldOutDetails/${row.taskId}` })
        },
        resetForm() {
