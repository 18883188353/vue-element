            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <el-link
                            type="primary"
                            @click="auditCommodityDetails(scope.row)"
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticGoodsAudit'
            }, {
                name: '全球购',
                code: 'GlobalGoodsAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryGoodsAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticGoodsAudit', 'GlobalGoodsAudit','LuxuryGoodsAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditCommodityDetails(row) {
            this.$router.push({ path: `auditCommodityDetails/${row.taskId}` });
        },
        resetForm() {
