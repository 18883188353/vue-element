...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'EvaluationResponseAudit'
            }, {
                name: '全球购',
                code: 'GlobalShopResponseEvaluateAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryShopResponseEvaluateAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['EvaluationResponseAudit', 'GlobalShopResponseEvaluateAudit', 'LuxuryShopResponseEvaluateAudit'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditEvaluateReplyDetails/${row.taskId}` })
        },
        resetForm() {
