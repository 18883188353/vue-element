    ...
    data() {
        return {
            taskTypeNames: [{
                ...
                name: '全球购',
                code: 'GlobalEvaluateAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryEvaluateAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['EvaluateAudit', 'GlobalEvaluateAudit', 'LuxuryEvaluateAudit'], // 审核任务名称
    ...
    methods: {
        ...
        */
        auditEvaluateDetails(row) {
            this.$router.push({ path: `auditEvaluateDetails/${row.taskId}` })
        },
        resetForm() {
