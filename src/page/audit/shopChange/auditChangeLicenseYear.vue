                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticYearReportAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalYearReportAudit"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticYearReportAudit'
            }, {
                name: '全球购',
                code: 'GlobalYearReportAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryYearReportAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticYearReportAudit', 'GlobalYearReportAudit', 'LuxuryYearReportAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditChangeLicenseYearDetails/${row.taskId}` });
        }
