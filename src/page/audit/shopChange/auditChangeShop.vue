                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticEditShopInfo"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalEditShopInfo"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticEditShopInfo'
            }, {
                name: '全球购',
                code: 'GlobalEditShopInfo'
            }, {
                name: '奢侈品',
                code: 'LuxuryEditShopInfo'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticEditShopInfo', 'GlobalEditShopInfo', 'LuxuryEditShopInfo'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditChangeShopDetails/${row.taskId}` });
        }
