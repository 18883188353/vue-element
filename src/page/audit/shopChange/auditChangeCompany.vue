    ...
    <div>
        ...
        <el-card class="box-card">
            ...
            >
                ...
                <el-table-column
                    prop="NewCompanyInfo.company_name"
                    label="公司名称"
                    align="center"
                    minWidth="260"
                    :show-overflow-tooltip="true"
                ...
                <el-table-column
                    prop="NewCompanyInfo.company_type"
                    label="公司类型"
                    align="center"
                    width="160"
                >
                ...
                <el-table-column
                    prop="NewCompanyInfo.manager_name"
                    label="负责人姓名"
                    align="center"
                    width="160"
                >
                ...
                <el-table-column
                    prop="NewCompanyInfo.company_tel"
                    label="联系电话"
                    align="center"
                    width="160"
                >
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticEditCompany'
            }, {
                name: '全球购',
                code: 'GlobalEditCompany'
            }, {
                name: '奢侈品',
                code: 'LuxuryEditCompany'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticEditCompany', 'GlobalEditCompany', 'LuxuryEditCompany'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditChangeCompanyDetails/${row.taskId}` });
        }
