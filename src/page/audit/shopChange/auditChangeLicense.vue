                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticLicenseAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalLicenseAudit"
                                ></el-option> -->
...
taskTypeNames: [{
                name: '国内购',
                code: 'DomesticLicenseAudit'
            }, {
                name: '全球购',
                code: 'GlobalLicenseAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryLicenseAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticLicenseAudit','GlobalLicenseAudit', 'LuxuryLicenseAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditChangeLicenseDetails/${row.taskId}` });
        }
