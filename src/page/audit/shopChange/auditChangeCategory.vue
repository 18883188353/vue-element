                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                <!-- <el-option
                                    label="国内购"
                                    value="DomesticCategoryAudit"
                                ></el-option>
                                <el-option
                                    label="全球购"
                                    value="GlobalCategoryAudit"
                                ></el-option> -->
                            </el-select>
                        </el-form-item>
                        <el-form-item
...
export default {
    ...
    data() {
        return {
            taskTypeNames: [{
                name: '国内购',
                code: 'DomesticCategoryAudit'
            }, {
                name: '全球购',
                code: 'GlobalCategoryAudit'
            }, {
                name: '奢侈品',
                code: 'LuxuryCategoryAudit'
            }],
            queryCondition: { // 查询条件
                taskTypeName: ['DomesticCategoryAudit', 'GlobalCategoryAudit', 'LuxuryCategoryAudit'], // 审核任务名称
    ...
    methods: {
        ...
        auditCheckInDetails(row) {
            this.$router.push({ 'path': `auditChangeCategoryDetails/${row.taskId}` });
        },
        resetForm() {
