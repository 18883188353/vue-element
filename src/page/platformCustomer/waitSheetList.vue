                    ...
                    <div class="mt20">
                        ...
                        >
                            ...
                            <!--<el-form-item label="处理状态:">
                                <el-select v-model="postData.orPlate" placeholder="处理状态">
                                    <el-option :label="item.text" :value="item.value" :key="item.value" v-for="item in orPlateOption"></el-option>
                                </el-select>
                            </el-form-item>-->
                ...
                >
                    ...
                    >
                        <template slot-scope="scope">
                            ...
                            <el-link
                                type="primary"
                                v-if="scope.row.sheetStatus !== '已完成' && scope.row.sheetStatus !== '已撤销'"
...
export default {
    ...
    methods: {
        ...
        searchList() {
            ...
            CsServiceSelectWaitSheetList.call(this, _postData).then(res => {
                if (res.Code === 1) {
